...
' The ClassInterface/None addribute prevents an empty interface calledre
...
<Guid("5276d38b-2048-4b9c-8761-c9a94d6aa372")>
<ProgId("ASCOM.ES_PMC8.Telescope")>
<ServedClassName("PMC8 Telescope")>
...
Public Class Telescope
    ...
    Private TL As TraceLogger   ' = SharedResources.SharedTraceLogger() ' Private variable to hold the trace logger object (creates a diagnostic log file with information that you specify)
    ...
    Public Sub New()
        Try
            ...
            'TL = SharedResources.SharedTraceLogger()
            TL.Enabled = traceState
            'TL.LogMessage("ASCOM_ES_PMC8.Telescope", "Starting initialization")
        ...
        Catch ex As Exception
            System.Windows.Forms.MessageBox.Show("Telescope New: " + ex.ToString())  'TODO: Remove
        End Try
...
#Region "Common properties and methods"
    ...
    Public Function CommandString(ByVal Command As String, Optional ByVal Raw As Boolean = False) As String _
        ...
        If IsConnected Then
            If Not WirelessEnabled Then
                'objSerial.Transmit(Command)                        'TODO: Main serial call changed
                TL.LogMessage("Command$ Transmitted", Command)
                'ES Command Language Terminator String ! (SHRIEK)
                'receiveString = objSerial.ReceiveTerminated("!")   'TODO: Main serial call changed
                receiveString = SharedResources.SendMessage(Command)
                cmdString = receiveString
                TL.LogMessage("Command$ Received", cmdString)
                'objSerial.ClearBuffers() 'clear out waiting for next command   'TODO: Main serial call changed
    ...
    Private Function VerifySerialComml() As Boolean
        ...
        Try
            ...
            End If
            SharedResources.SharedSerial.Speed = comSpeed
            ...
            SharedResources.Connected = True    'TODO: serial port
        ...
        Set(value As Boolean)
            ...
            Else
                ...
                If Not WirelessEnabled Then
                    ...
                    'objSerial.ClearBuffers()           'TODO: Shared Serial - Shared resource will clean up
...
#End Region
    ...
    Private ReadOnly Property IsConnected As Boolean
        Get
            ...
            'Return SharedResources.Connected        'TODO: Connected change
