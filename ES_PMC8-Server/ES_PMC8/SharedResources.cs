    ...
    public static class SharedResources
    {
        ...
        public static string SendMessage(string message)
        {
            ...
            lock (lockObject)
            {
                ...
                string res = SharedSerial.ReceiveTerminated("!");
                Console.WriteLine("     Rsult: " + res);
                return res;
            }
        }
        ...
        public static bool Connected
        {
            set
            {
                Console.WriteLine("CONNECTED - SET: " + value);
                lock (lockObject)
                {
                    if (value)
                    {
            ...
            get
            {
                Console.WriteLine("CONNECTED - GET:  " + SharedSerial.Connected);
