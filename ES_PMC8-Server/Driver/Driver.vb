...
'<Guid("5276d38b-2048-4b9c-8761-c9a94d6aa372")> ORIGINAL GUID
'<ClassInterface(ClassInterfaceType.None)>
'<ProgId(“ASCOM.ES_PMC8.Telescope”)>
'<ServedClassName(“ES8 Telescope Driver”)>
' ORIINAL PROGRAM INFO GUID: b13cc1fb-77a5-4993-8231-5553ce9bbda8

<Guid("5276d38b-2048-4b9c-8761-c9a94d6aa373")>
<ClassInterface(ClassInterfaceType.None)>
<ProgId(“ASCOM.PMC8.Telescope”)>
<ServedClassName(“PMC8 Telescope Server”)>
Public Class Telescope
    ...
    '
    Public Shared driverID As String = "ASCOM.PMC8.Telescope"
    Public Shared driverDescription As String = "ES_PMC8 Telescope Server"
    Public Shared comPortProfileName As String = "COM Port" 'Constants used for Profile persistence
    Public Shared comSpeedProfileName As String = "COM Speed"
    Public Shared traceStateProfileName As String = "Trace Level"
    Public Shared IPAddressProfileName As String = "IP Address"
    Public Shared IPPortProfileName As String = "IP Port"
    Public Shared WirelessEnabledProfileName As String = "Wireless Enabled"
    Public Shared WirelessProtocolProfileName As String = "Wireless Protocol"
    Public Shared MountProfileName As String = "Mount Type"
    Public Shared RateProfileName As String = "Mount Rate"
    Public Shared MountRACountsProfileName As String = "Total RA Counts"
    Public Shared MountDECCountsProfileName As String = "Total DEC Counts"
    Public Shared ApertureDiameterProfileName As String = "Telescope Aperture Diameter"
    Public Shared ApertureAreaProfileName As String = "Telescope Aperture Area"
    Public Shared FocalLengthProfileName As String = "Telescope Focal Length"
    Public Shared SiteLocationProfileName As String = "Site Location"
    Public Shared SiteElevationProfileName As String = "Site Elevation meters"
    ...
    Public Shared RateOffsetProfileName As String = "Rate Offset arc-sec/sec"
    Public Shared SiteAmbientTemperatureProfileName As String = "Site Ambient Temperature"
    Public Shared ParkRAPositionProfileName As String = "RA Park Position"
    Public Shared ParkDECPositionProfileName As String = "DEC Park Position"
    Public Shared ApplyRefractionCorrectionProfileName As String = "RefractionApplied"
    Public Shared RA_SiderealRateFractionProfileName As String = "RA Sidereal Rate Fraction"
    Public Shared DEC_SiderealRateFractionProfileName As String = "DEC Sidereal Rate Fraction"
    Public Shared MininumPulseTimeProfileName As String = "Minimum Pulse Time"
    Public Shared WiFiModuleIDProfileName As String = "WIFI Module ID"
    ...
    Public Shared comPort As String ' Variables to hold the currrent device configuration
    Public Shared comSpeed As String
    Public Shared traceState As Boolean
    Public Shared IPAddress As String
    Public Shared IPPort As String
    Public Shared WirelessEnabled As Boolean
    Public Shared WirelessProtocol As String
    Public Shared Mount As String
    Public Shared Rate As String
    Public Shared MountRACounts As Long
    Public Shared MountDECCounts As Long
    Public Shared ApertureDiameterValue As Double
    Public Shared ApertureAreaValue As Double
    Public Shared FocalLengthValue As Double
    Public Shared SiteLocation As String
    Public Shared SiteElevationValue As Double
    Public Shared SiteLongitudeValue As Double
    Public Shared SiteLatitudeValue As Double
    Public Shared RateOffsetValue As Double
    Public Shared SiteAmbientTemperatureValue As Double
    Public Shared ParkRAPosition As Int32
    Public Shared ParkDECPosition As Int32
    Public Shared ApplyRefractionCorrection As Boolean
    Public Shared RA_SiderealRateFraction As Single
    Public Shared DEC_SiderealRateFraction As Single
    Public Shared MinimumPulseTime As Int16
    Public Shared WiFiModuleID As String
    ...
    Private objSerial As ASCOM.Utilities.Serial = SharedResources.SharedSerial 'Serial Port object
    ...
    Private ParkStatus As Boolean = False 'NOTE - Changed from true
    ...
    Public Property ParkStatusProp() As Boolean
        Get
            Return SharedResources.sharedAtPark
        End Get
        Set(ByVal value As Boolean)
            SharedResources.sharedAtPark = value
        End Set
    End Property

    Public Property ConnectedStateProp() As Boolean
        Get
            Return connectedState
        End Get
        Set(ByVal value As Boolean)
            If ((value = True) And (connectedState = False)) Then
                SharedResources.Connected = True
            End If
            If ((value = False) And (connectedState = True)) Then
    ...
    '
    Public Sub New()
        MessageBox.Show("CONNECT 1 - Driver", "NOTICE")
        ...
        ConnectedStateProp = False ' Initialise connected to false
        ...
        _guid = SharedResources.GetGud()
        Dim curDur As String = Directory.GetCurrentDirectory()
        MessageBox.Show("Shared Resources = " + _guid.ToString() + Environment.NewLine + CurDir())
        Dim timer As System.Timers.Timer = New System.Timers.Timer(2000)
        AddHandler timer.Elapsed, New ElapsedEventHandler(AddressOf TimerElapsed)
        timer.Start()

        'SharedResources.SharedSerial.PortName = "COM3"
        'SharedResources.SharedSerial.Port = 3
        ...
        'SharedResources.Connected = True
        'connectedState = True
        'Dim result As String = SharedResources.SendMessage("ESGv!")
        objTransform.SiteLatitude = Me.SiteLatitude
        objTransform.SiteLongitude = Me.SiteLongitude
        objTransform.SiteElevation = Me.SiteElevation
        objTransform.SiteTemperature = SiteAmbientTemperatureValue
    ...
    Private Sub TimerElapsed(ByVal sender As Object, ByVal e As ElapsedEventArgs)
        ...
        If Me.IsConnected Then
            ...
            Console.WriteLine("RA = " + Me.RightAscension.ToString() + " Dec = " + Me.Declination.ToString())
        Else
...
#Region "Common properties and methods"
    ...
    Public Sub SetupDialog() Implements ITelescopeV3.SetupDialog
        ...
        Using F As SetupDialogForm2 = New SetupDialogForm2()
    ...
    Public Function CommandString(ByVal Command As String, Optional ByVal Raw As Boolean = False) As String _
        ...
        If IsConnected Then
            If Not WirelessEnabled Then
                ...
                receiveString = SharedResources.SendMessage(Command)
                ...
                Console.WriteLine(" Received: " + cmdString)
    ...
    Public Property Connected() As Boolean Implements ITelescopeV3.Connected
        ...
        Set(value As Boolean)
            ...
            Else
                ...
                If Not WirelessEnabled Then
                    objSerial.ClearBuffers()
                    'objSerial.Connected = False 'NOTE - changed
                    'objSerial.Dispose() 'NOTE - changed
                    'objSerial = Nothing 'NOTE - changed
                    ConnectedStateProp = False
                Else
                    'objTCPNetwork.Close()
                    'objTCPNetwork = Nothing
...
#Region "ITelescope Implementation"
    ...
    Public ReadOnly Property AtPark() As Boolean Implements ITelescopeV3.AtPark
        Get
            TL.LogMessage("AtPark", "Get - " & ParkStatusProp.ToString())
            Return ParkStatusProp
        End Get
    End Property
            ...
            Try
                ...
                ElseIf (RARate < minSlewRate) And (DECRate < minSlewRate) Then
                    ...
                    If Not AltAzSlew Then
                        If (ParkStatusProp = True) Or (HomeStatus = True) Then
                            If ParkStatusProp Then
                                ParkStatusProp = True
    ...
    Public Sub Unpark() Implements ITelescopeV3.Unpark
        Try
            If ParkStatusProp = True Then
                ParkStatusProp = False
                TL.LogMessage("Unpark", "Found Parkstatus=TRUE, UnParked!")
            ElseIf ParkStatusProp = False Then
