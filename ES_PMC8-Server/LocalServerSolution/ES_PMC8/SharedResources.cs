...
namespace ASCOM.ES_PMC8
{
    ...
    public static class SharedResources
    {
        ...
        public static int s_z = 0;     // counter for the number of connections to the serial port
        public static bool sharedAtPark = true;
        private static Guid _guid = Guid.NewGuid();
        public static Guid GetGud()
        {
            return _guid;
        }
        //
        ...
        {
            //if (SharedSerial.Connected == false)
            //{
            //    SharedSerial.Speed = Utilities.SerialSpeed.ps115200;
            //    SharedSerial.ReceiveTimeout = 1;
            //    SharedSerial.DataBits = 8;
            //    SharedSerial.StopBits = Utilities.SerialStopBits.One;
            //    SharedSerial.Parity = Utilities.SerialParity.None;
            //    SharedSerial.Handshake = Utilities.SerialHandshake.None;
            //    SharedSerial.RTSEnable = false;
            //    SharedSerial.DTREnable = false;
            //    SharedSerial.PortName = "COM3";
            ...
            lock (lockObject)
            {
                ...
                string result = SharedSerial.ReceiveTerminated("!");
                return result;
            }
        }
